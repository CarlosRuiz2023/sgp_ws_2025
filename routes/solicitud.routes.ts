...
api.post('/', _Obra_Middleware.validar_id_obra, _Solicitud_Middleware.validar_id_usuario_laboratorio, _Solicitud_Middleware.validar_id_usuario_ms, _UTIL_JWT.comprobarJWT.bind(_UTIL_JWT), _Solicitud_Interface.agregarSolicitud);
